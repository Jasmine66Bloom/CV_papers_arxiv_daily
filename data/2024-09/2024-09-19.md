...
|---|---|---|---|---|---|
**2024-09-19**|**BGDB: Bernoulli-Gaussian Decision Block with Improved Denoising   Diffusion Probabilistic Models**|BGDB：具有改进去噪扩散概率模型的伯努利-高斯决策块|Chengkun Sun, Jinqian Pan, Russell Stevens Terry, Jiang Bian, Jie Xu|<http://arxiv.org/pdf/2409.13116v1>|null
**2024-09-19**|**What does guidance do? A fine-grained analysis in a simple setting**|指导的作用何在？一种在简单设定下的细粒度分析|Muthu Chidambaram, Khashayar Gatmiry, Sitan Chen, Holden Lee, Jianfeng Lu|<http://arxiv.org/pdf/2409.13074v1>|null
**2024-09-19**|**TACE: Tumor-Aware Counterfactual Explanations**|TACE：肿瘤感知反事实解释|Eleonora Beatrice Rossi, Eleonora Lopez, Danilo Comminiello|<http://arxiv.org/pdf/2409.13045v1>|null
**2024-09-19**|**LVCD: Reference-based Lineart Video Colorization with Diffusion Models**|基于参考的线条视频着色与扩散模型（LVCD）|Zhitong Huang, Mohan Zhang, Jing Liao|<http://arxiv.org/pdf/2409.12960v1>|null
**2024-09-19**|**3DTopia-XL: Scaling High-quality 3D Asset Generation via Primitive   Diffusion**|3DTopia-XL：通过基本扩散实现高质量三维资产生成的规模化扩展|Zhaoxi Chen, Jiaxiang Tang, Yuhao Dong, Ziang Cao, Fangzhou Hong, Yushi Lan, Tengfei Wang, Haozhe Xie, Tong Wu, Shunsuke Saito, et.al.|<http://arxiv.org/pdf/2409.12957v1>|**[link](https://github.com/3dtopia/3dtopia-xl)**
**2024-09-19**|**The Gaussian Discriminant Variational Autoencoder (GdVAE): A   Self-Explainable Model with Counterfactual Explanations**|高斯判别变分自编码器（GdVAE）：具有反事实解释的自解释模型|Anselm Haselhoff, Kevin Trelenberg, Fabian Küppers, Jonas Schneider|<http://arxiv.org/pdf/2409.12952v1>|**[link](https://github.com/trustinai/gdvaecode)**
**2024-09-19**|**TEAM PILOT -- Learned Feasible Extendable Set of Dynamic MRI Acquisition   Trajectories**|TEAM PILOT：学习型动态MRI采集轨迹的可行扩展集合研究|Tamir Shor, Chaim Baskin, Alex Bronstein|<http://arxiv.org/pdf/2409.12777v1>|null
**2024-09-19**|**Generation and Editing of Mandrill Faces: Application to Sex Editing and   Assessment**|曼陀罗面部生成与编辑：在性别编辑与评估中的应用|Nicolas M. Dibot, Julien P. Renoult, William Puech|<http://arxiv.org/pdf/2409.12705v1>|null
**2024-09-19**|**Image inpainting for corrupted images by using the semi-super resolution   GAN**|基于半监督超分辨率GAN的损坏图像修复技术研究|Mehrshad Momen-Tayefeh, Mehrdad Momen-Tayefeh, Amir Ali Ghafourian Ghahramani|<http://arxiv.org/pdf/2409.12636v1>|null
**2024-09-19**|**CF-GO-Net: A Universal Distribution Learner via Characteristic Function   Networks with Graph Optimizers**|CF-GO-Net：基于特征函数网络与图优化器的通用分布学习模型|Zeyang Yu, Shengxi Li, Danilo Mandic|<http://arxiv.org/pdf/2409.12610v1>|null
**2024-09-19**|**Improving Cone-Beam CT Image Quality with Knowledge   Distillation-Enhanced Diffusion Model in Imbalanced Data Settings**|提高锥束CT图像质量：在数据不平衡设置中使用知识蒸馏增强的扩散模型|Joonil Hwang, Sangjoon Park, NaHyeon Park, Seungryong Cho, Jin Sung Kim|<http://arxiv.org/pdf/2409.12539v1>|null
**2024-09-19**|**Denoising Reuse: Exploiting Inter-frame Motion Consistency for Efficient   Video Latent Generation**|视频潜在生成的高效利用：基于帧间运动一致性的去噪复用技术|Chenyu Wang, Shuo Yan, Yixuan Chen, Yujiang Wang, Mingzhi Dong, Xiaochen Yang, Dongsheng Li, Robert P. Dick, Qin Lv, Fan Yang, et.al.|<http://arxiv.org/pdf/2409.12532v1>|null
**2024-09-19**|**HSIGene: A Foundation Model For Hyperspectral Image Generation**|HSIGene：一种用于高光谱图像生成的基础模型|Li Pang, Datao Tang, Shuang Xu, Deyu Meng, Xiangyong Cao|<http://arxiv.org/pdf/2409.12470v1>|**[link](https://github.com/lipang/hsigene)**
**2024-09-19**|**Bayesian-Optimized One-Step Diffusion Model with Knowledge Distillation   for Real-Time 3D Human Motion Prediction**|贝叶斯优化的一步扩散模型与知识蒸馏用于实时三维人体动作预测|Sibo Tian, Minghui Zheng, Xiao Liang|<http://arxiv.org/pdf/2409.12456v1>|null
**2024-09-19**|**Domain-stratified Training for Cross-organ and Cross-scanner   Adenocarcinoma Segmentation in the COSAS 2024 Challenge**|域分层训练在COSAS 2024挑战中的跨器官和跨扫描器腺癌分割应用|Huang Jiayan, Ji Zheng, Kuang Jinbo, Xu Shuoyu|<http://arxiv.org/pdf/2409.12418v1>|null
**2024-09-19**|**I2I-Galip: Unsupervised Medical Image Translation Using Generative   Adversarial CLIP**|I2I-Galip: 使用生成对抗性CLIP的无监督医学图像翻译|Yilmaz Korkmaz, Vishal M. Patel|<http://arxiv.org/pdf/2409.12399v1>|**[link](https://github.com/yilmazkorkmaz1/i2i-galip)**
**2024-09-19**|**Look Through Masks: Towards Masked Face Recognition with De-Occlusion   Distillation**|透过口罩：面向去遮挡的遮罩人脸识别蒸馏技术|Chenyu Li, Shiming Ge, Daichi Zhang, Jia Li|<http://arxiv.org/pdf/2409.12385v1>|null
**2024-09-19**|**Fundus image enhancement through direct diffusion bridges**|基于直接扩散桥的眼底图像增强方法|Sehui Kim, Hyungjin Chung, Se Hie Park, Eui-Sang Chung, Kayoung Yi, Jong Chul Ye|<http://arxiv.org/pdf/2409.12377v1>|**[link](https://github.com/heeheee888/fd3)**
**2024-09-19**|**Cross-Organ and Cross-Scanner Adenocarcinoma Segmentation using Rein to   Fine-tune Vision Foundation Models**|跨器官与跨扫描仪的腺癌分割：利用Rein微调视觉基础模型|Pengzhou Cai, Xueyuan Zhang, Libin Lan, Ze Zhao|<http://arxiv.org/pdf/2409.11752v2>|null
...
**2024-09-19**|**Enhancing Perception of Key Changes in Remote Sensing Image Change   Captioning**|增强遥感影像变化标注中对关键变化的感知能力|Cong Yang, Zuchao Li, Hongzan Jiao, Zhi Gao, Lefei Zhang|<http://arxiv.org/pdf/2409.12612v1>|**[link](https://github.com/yangcong356/kcfi)**
...
|Publish Date|Title|Title_CN|Authors|PDF|Code|
|---|---|---|---|---|---|
**2024-09-19**|**Revisiting Semi-supervised Adversarial Robustness via Noise-aware Online   Robust Distillation**|重新审视基于噪声感知在线鲁棒蒸馏的半监督对抗鲁棒性|Tsung-Han Wu, Hung-Ting Su, Shang-Tse Chen, Winston H. Hsu|<http://arxiv.org/pdf/2409.12946v1>|null
**2024-09-19**|**Towards Low-latency Event-based Visual Recognition with Hybrid Step-wise   Distillation Spiking Neural Networks**|迈向低延迟事件驱动视觉识别：混合逐步蒸馏脉冲神经网络研究|Xian Zhong, Shengwang Hu, Wenxuan Liu, Wenxin Huang, Jianhao Ding, Zhaofei Yu, Tiejun Huang|<http://arxiv.org/pdf/2409.12507v1>|null
**2024-09-19**|**Privacy-Preserving Student Learning with Differentially Private   Data-Free Distillation**|隐私保护的学生学习：基于差分隐私的无数据蒸馏方法|Bochao Liu, Jianghu Lu, Pengju Wang, Junjie Zhang, Dan Zeng, Zhenxing Qian, Shiming Ge|<http://arxiv.org/pdf/2409.12384v1>|null
**2024-09-19**|**Rethinking Early-Fusion Strategies for Improved Multispectral Object   Detection**|重新思考早期融合策略以提升多光谱目标检测性能|Xue Zhang, Si-Yuan Cao, Fang Wang, Runmin Zhang, Zhe Wu, Xiaohan Zhang, Xiaokai Bai, Hui-Liang Shen|<http://arxiv.org/pdf/2405.16038v2>|**[link](https://github.com/xuez-phd/efficient-rgb-t-early-fusion-detection)**

## 分类/检测/识别/分割/...

|Publish Date|Title|Title_CN|Authors|PDF|Code|
|---|---|---|---|---|---|
**2024-09-19**|**AutoPET III Challenge: Tumor Lesion Segmentation using ResEnc-Model   Ensemble**|AutoPET III挑战赛：基于ResEnc-Model集成学习的肿瘤病变分割|Tanya Chutani, Saikiran Bonthu, Pranab Samanta, Nitin Singhal|<http://arxiv.org/pdf/2409.13779v1>|null
**2024-09-19**|**Classification of 4 types of White blood cell images**|四种白细胞图像的分类研究|Rabia Asghar, Arslan Shaukat, Usman Akram, Rimsha Tariq|<http://arxiv.org/pdf/2409.13442v1>|null
**2024-09-19**|**Evolution and challenges of computer vision and deep learning   technologies for analysing mixed construction and demolition waste**|计算机视觉与深度学习技术在分析混合建筑废弃物中的演变与挑战|Adrian Langley, Matthew Lonergan, Tao Huang, Mostafa Rahimi Azghadi|<http://arxiv.org/pdf/2409.13112v1>|null
**2024-09-19**|**Interpretable Action Recognition on Hard to Classify Actions**|难以分类动作的可解释动作识别|Anastasia Anichenko, Frank Guerin, Andrew Gilbert|<http://arxiv.org/pdf/2409.13091v1>|null
**2024-09-19**|**Cross-Chirality Palmprint Verification: Left is Right for the Right   Palmprint**|跨手性掌纹验证：左即右，右掌纹的正确之选|Chengrui Gao, Ziyuan Yang, Tiong-Sik Ng, Min Zhu, Andrew Beng Jin Teoh|<http://arxiv.org/pdf/2409.13056v1>|null
**2024-09-19**|**AutoPET III Challenge: PET/CT Semantic Segmentation**|AutoPET III挑战赛：PET/CT语义分割|Reza Safdari, Mohammad Koohi-Moghaddam, Kyongtae Tyler Bae|<http://arxiv.org/pdf/2409.13006v1>|null
**2024-09-19**|**Semi-overcomplete convolutional auto-encoder embedding as shape priors   for deep vessel segmentation**|半过完备卷积自动编码器嵌入作为深度血管分割的形状先验|Amine Sadikine, Bogdan Badic, Jean-Pierre Tasu, Vincent Noblet, Dimitris Visvikis, Pierre-Henri Conze|<http://arxiv.org/pdf/2409.13001v1>|null
**2024-09-19**|**Recognition of Harmful Phytoplankton from Microscopic Images using Deep   Learning**|toplankton 利用深度学习从显微图像中识别有害浮游植物|Aymane Khaldi, Rohaifa Khaldi|<http://arxiv.org/pdf/2409.12900v1>|null
**2024-09-19**|**Hypersphere Secure Sketch Revisited: Probabilistic Linear Regression   Attack on IronMask in Multiple Usage**|超球面安全草图再探：针对IronMask多用途的概率线性回归攻击|Pengxu Zhu, Lei Wang|<http://arxiv.org/pdf/2409.12884v1>|null
**2024-09-19**|**Improving Prototypical Parts Abstraction for Case-Based Reasoning   Explanations Designed for the Kidney Stone Type Recognition**|改进原型部件抽象以提高基于案例推理的肾结石类型识别解释设计|Daniel Flores-Araiza, Francisco Lopez-Tiro, Clément Larose, Salvador Hinojosa, Andres Mendez-Vazquez, Miguel Gonzalez-Mendoza, Gilberto Ochoa-Ruiz, Christian Daul|<http://arxiv.org/pdf/2409.12883v1>|null
**2024-09-19**|**Deep Learning-Based Detection of Referable Diabetic Retinopathy and   Macular Edema Using Ultra-Widefield Fundus Imaging**|基于深度学习的超广角眼底成像技术在检测可参考性糖尿病视网膜病变和黄斑水肿中的应用研究|Philippe Zhang, Pierre-Henri Conze, Mathieu Lamard, Gwenolé Quellec, Mostafa El Habib Daho|<http://arxiv.org/pdf/2409.12854v1>|null
**2024-09-19**|**Automated Linear Disturbance Mapping via Semantic Segmentation of   Sentinel-2 Imagery**|自动线性干扰映射：基于Sentinel-2影像语义分割的实现|Andrew M. Nagel, Anne Webster, Christopher Henry, Christopher Storie, Ignacio San-Miguel Sanchez, Olivier Tsui, Jason Duffe, Andy Dean|<http://arxiv.org/pdf/2409.12817v1>|null
**2024-09-19**|**Multi-Source and Multi-Sequence Myocardial Pathology Segmentation Using   a Cascading Refinement CNN**|多源多序列心肌病变分割的级联细化卷积神经网络方法|Franz Thaler, Darko Stern, Gernot Plank, Martin Urschler|<http://arxiv.org/pdf/2409.12792v1>|null
**2024-09-19**|**COCO-Occ: A Benchmark for Occluded Panoptic Segmentation and Image   Understanding**|COCO-Occ：遮挡全景分割与图像理解基准数据集|Wenbo Wei, Jun Wang, Abhir Bhalerao|<http://arxiv.org/pdf/2409.12760v1>|null
...
**2024-09-19**|**Towards Physically-Realizable Adversarial Attacks in Embodied Vision   Navigation**|面向具身视觉导航中物理可实现的对抗性攻击研究|Meng Chen, Jiawei Tu, Chao Qi, Yonghao Dang, Feng Zhou, Wei Wei, Jianqin Yin|<http://arxiv.org/pdf/2409.10071v2>|**[link](https://github.com/chen37058/physical-attacks-in-embodied-navigation)**
...
|Publish Date|Title|Title_CN|Authors|PDF|Code|
|---|---|---|---|---|---|
**2024-09-19**|**Explainable AI for Autism Diagnosis: Identifying Critical Brain Regions   Using fMRI Data**|可解释AI在自闭症诊断中的应用：利用fMRI数据识别关键脑区|Suryansh Vidya, Kush Gupta, Amir Aly, Andy Wills, Emmanuel Ifeachor, Rohit Shankar|<http://arxiv.org/pdf/2409.15374v1>|null
**2024-09-19**|**UL-VIO: Ultra-lightweight Visual-Inertial Odometry with Noise Robust   Test-time Adaptation**|UL-VIO：具有噪声鲁棒性的超轻量级视觉-惯性里程计与测试时自适应|Jinho Park, Se Young Chun, Mingoo Seok|<http://arxiv.org/pdf/2409.13106v1>|null
**2024-09-19**|**ERIC: Estimating Rainfall with Commodity Doorbell Camera for Precision   Residential Irrigation**|ERIC：利用商用门铃摄像头估算降雨量以实现精准居民灌溉|Tian Liu, Liuyi Jin, Radu Stoleru, Amran Haroon, Charles Swanson, Kexin Feng|<http://arxiv.org/pdf/2409.13104v1>|null
**2024-09-19**|**Embedding Geometries of Contrastive Language-Image Pre-Training**|对比语言-图像预训练中的几何嵌入研究|Jason Chuan-Chih Chou, Nahid Alam|<http://arxiv.org/pdf/2409.13079v1>|**[link](https://github.com/eify/open_clip)**
**2024-09-19**|**DiffSSD: A Diffusion-Based Dataset For Speech Forensics**|基于扩散的语音取证数据集DiffSSD|Kratika Bhagtani, Amit Kumar Singh Yadav, Paolo Bestagini, Edward J. Delp|<http://arxiv.org/pdf/2409.13049v1>|null
**2024-09-19**|**DNI: Dilutional Noise Initialization for Diffusion Video Editing**|DNI：用于扩散视频编辑的稀释噪声初始化方法|Sunjae Yoon, Gwanhyeong Koo, Ji Woo Hong, Chang D. Yoo|<http://arxiv.org/pdf/2409.13037v1>|null
**2024-09-19**|**Accelerating AI and Computer Vision for Satellite Pose Estimation on the   Intel Myriad X Embedded SoC**|卫星姿态估计的AI与计算机视觉加速研究：基于Intel Myriad X嵌入式SoC|Vasileios Leon, Panagiotis Minaidis, George Lentaris, Dimitrios Soudris|<http://arxiv.org/pdf/2409.12939v1>|null
**2024-09-19**|**PVContext: Hybrid Context Model for Point Cloud Compression**|PVContext: 点云压缩的混合上下文模型|Guoqing Zhang, Wenbo Zhao, Jian Liu, Yuanchao Bai, Junjun Jiang, Xianming Liu|<http://arxiv.org/pdf/2409.12724v1>|null
**2024-09-19**|**Multi-Scale Feature Prediction with Auxiliary-Info for Neural Image   Compression**|多尺度特征预测结合辅助信息用于神经图像压缩|Chajin Shin, Sangjin Lee, Sangyoun Lee|<http://arxiv.org/pdf/2409.12719v1>|null
**2024-09-19**|**Reference Dataset and Benchmark for Reconstructing Laser Parameters from   On-axis Video in Powder Bed Fusion of Bulk Stainless Steel**|参考数据集与基准：从块状不锈钢粉末床熔融中的轴向视频重建激光参数|Cyril Blanc, Ayyoub Ahar, Kurt De Grave|<http://arxiv.org/pdf/2409.12475v1>|null
**2024-09-19**|**How to predict on-road air pollution based on street view images and   machine learning: a quantitative analysis of the optimal strategy**|基于街景图像与机器学习预测道路空气污染的最佳策略定量分析|Hui Zhong, Di Chen, Pengqin Wang, Wenrui Wang, Shaojie Shen, Yonghong Liu, Meixin Zhu|<http://arxiv.org/pdf/2409.12412v1>|null
**2024-09-19**|**Adaptive Selection of Sampling-Reconstruction in Fourier Compressed   Sensing**|自适应傅里叶压缩感知中的采样-重建选择策略|Seongmin Hong, Jaehyeok Bae, Jongho Lee, Se Young Chun|<http://arxiv.org/pdf/2409.11738v2>|null
**2024-09-19**|**Denoising: A Powerful Building-Block for Imaging, Inverse Problems, and   Machine Learning**|去噪：成像、逆问题和机器学习中的一个强大基础模块|Peyman Milanfar, Mauricio Delbracio|<http://arxiv.org/pdf/2409.06219v2>|null
**2024-09-19**|**CLIP-AGIQA: Boosting the Performance of AI-Generated Image Quality   Assessment with CLIP**|of  CLIP-AGIQA：利用CLIP提升人工智能生成图像质量评估性能|Zhenchen Tang, Zichuan Wang, Bo Peng, Jing Dong|<http://arxiv.org/pdf/2408.15098v2>|null
**2024-09-19**|**Map-Free Visual Relocalization Enhanced by Instance Knowledge and Depth   Knowledge**|基于实例知识与深度知识的无地图视觉重定位增强方法|Mingyu Xiao, Runze Chen, Haiyong Luo, Fang Zhao, Juan Wang, Xuepeng Ma|<http://arxiv.org/pdf/2408.13085v3>|null
**2024-09-19**|**SUMix: Mixup with Semantic and Uncertain Information**|SUMix: 结合语义与不确定信息的Mixup方法|Huafeng Qin, Xin Jin, Hongyu Zhu, Hongchao Liao, Mounîm A. El-Yacoubi, Xinbo Gao|<http://arxiv.org/pdf/2407.07805v5>|**[link](https://github.com/Westlake-AI/openmixup)**
**2024-09-19**|**From Synthetic to Real: Unveiling the Power of Synthetic Data for Video   Person Re-ID**|从合成到真实：揭秘合成数据在视频行人重识别中的强大能力|Xiangqun Zhang, Wei Feng, Ruize Han, Likai Wang, Linqi Song, Junhui Hou|<http://arxiv.org/pdf/2402.02108v2>|null
