...
if __name__ == "__main__":
    ...
    keywords["Transformer"] = "cat:cs.CV" + "AND" + "\"transformer\"OR\"attention\""
    keywords["模型压缩/优化"] = "cat:cs.CV" + "AND" + "\"NAS\"OR\"Network Architecture Search\"OR\"Pruning\"OR\"Quantization\"OR\"Knowledge Distillation\"OR\"Distillation\"OR\"model optimizer\""
    keywords["生成模型"] = "cat:cs.CV" + "AND" + "\"diffusion model\"OR\"GAN\"OR\"vae\"OR\"Generative Adversarial Networ\""
    keywords["多模态"] = "cat:cs.CV" + "AND" + "\"multi-modal\"OR\"Multimodal\"OR\"vae\"OR\"Generative Adversarial Networ\""
    keywords["分类/检测/识别/分割"] = "cat:cs.CV" + "AND" + "\"object detection\"OR\"object recognition\"OR\"recognition\"OR\"image classification\"OR\"video classification\"OR\"segment\"OR\"segmentation\""
    keywords["OCR"] = "cat:cs.CV" + "AND" + "\"OCR\"OR\"Optical Character Recognition\""
    keywords["Zero/Few-Shot Learning"] = "cat:cs.CV" + "AND" + "\"zero-shot\"OR\"few-shot\""
    keywords["半监督/无监督学习"] = "cat:cs.CV" + "AND" + "\"Semi-supervised\"OR\"unsupervised\""
    keywords["3D相关"] = "cat:cs.CV" + "AND" + "\"3D\"OR\"3D detection\"OR\"3D reconstruction\"OR\"3D understanding\"\rendering\""
    keywords["图像理解"] = "cat:cs.CV" + "AND" + "\"Intrinsic Image Decomposition\"OR\"Intrinsic Image\"OR\"relighting\"OR\"recolor\"OR\"\image composition\""
    keywords["Nerf"] = "cat:cs.CV" + "AND" + "\"3D\"OR\"3D detection\"OR\"3D reconstruction\"OR\"3D understanding\"OR\"3d gaussian splatting\""
    keywords["GNN"] = "cat:cs.CV" + "AND" + "\"GNN\"OR\"Graph Neural Network\""
